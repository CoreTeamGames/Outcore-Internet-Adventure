...
namespace OutcoreInternetAdventure.UI
{
    ...
    public class AchievementSystemUI : MonoBehaviour
    {
        ...
        {
            _titleText.text = _localizationService.GetLocalizedLine(_achievementsFileName, achievement.TitleKey);
            _descriptionText.text = _localizationService.GetLocalizedLine(_achievementsFileName, achievement.DescriptionKey);
