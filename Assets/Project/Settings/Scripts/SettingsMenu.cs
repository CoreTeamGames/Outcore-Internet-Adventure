...
namespace OutcoreInternetAdventure.Settings
{
    public class SettingsMenu : MonoBehaviour
    {
        ...
        [SerializeField] List<Language> _languageList;
        ...
        public void SetupSettings()
        {
            ...
            foreach (var language in _localizationService.Languages)
            {
                if (language.LangLocale.ToLower() == _settings.LangLocale.ToLower())
                {
        ...
        public void SaveSettings()
        {
            ...
            _settings = new Settings(_sfxSlider.value, _CVVSlider.value, _musicSlider.value, _3DSoundToggle.isOn, _localizationService.CurrentLanguage.LangLocale,_brightnessSlider.value);
